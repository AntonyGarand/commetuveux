<div class="addPromoContent">
   ...
   <form id="addPromo">
	...
	<input type="hidden" id="promoServiceId" name="promoServiceId" value="" />
	   ...
	   <div class="addPromoSubmitWrapper"><input type="submit" name="addPromo" value="Confirmer" onclick="updatePromo()"/></div>
   </form>
</div>
...
class DPayPal {
    ...
    //API Credentials
    protected $username = "frappier.amelie-facilitator_api1.gmail.com"; //PayPal API username
    protected $password = "RVMGSAYQVZCQFEFM"; //PayPal API password
    protected $apiSignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31Aigdh5ynybbgVbAhuRq2nn2-ztk6"; //PayPal API signature
    protected $apiVersion = "98.0"; //Set PayPal API version
    ...
    public function sendRequest($requestData, $method) {
        ...
        $requestParameters = array(
            ...
            "okUrl" => "http://" . $_SERVER['HTTP_HOST'] . $_SERVER['PHP_SELF'] //Permet de rediriger la page qui appel PayPal après le traitement sur la page Curl
        );
        
        $requestParameters+=$requestData;
        $finalRequest = http_build_query($requestParameters);
        
        //redirection vers la page qui a Curl et qui fait les appels à PayPal
        header('Location:http://simontest.byethost10.com/lib/DPayPal.php?'.$finalRequest);

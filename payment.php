...
$requestParams = array(
    'RETURNURL' => "panier.php?confirmpayment=true", //Enter your webiste URL here
    'CANCELURL' => "panier.php?cancel=true" //Enter your website URL here
);
...
$orderParams = array(
    ...
    "BRANDNAME" => "Cours d'informatique Info++",
    "GIFTRECEIPTENABLE" => "0",
    "GIFTMESSAGEENABLE" => "0"
);
$item = array(
